...
d11 = datetime.strptime('6/21/2016 1:30 PM', '%m/%d/%Y %I:%M %p')
d12 = datetime.strptime('9/21/2017 4:50 AM', '%m/%d/%Y %I:%M %p')

d21 = datetime.strptime('9/21/2016 1:30 PM', '%m/%d/%Y %I:%M %p')
d22 = datetime.strptime('12/21/2016 4:50 AM', '%m/%d/%Y %I:%M %p')

d31 = datetime.strptime('12/21/2016 1:30 PM', '%m/%d/%Y %I:%M %p')
d32 = datetime.strptime('4/13/2017 4:50 AM', '%m/%d/%Y %I:%M %p')

user_id_range = list(range(40000, 40528)) + list(range(1089088, 1089097)) + [1119276, 1120471, 1172459, 1204988,
