...
def daily_summary_data():
    ...
    get_metrics = attrgetter('on_day', 'dau', 'wau', 'mau', 'new_reg', 'facebook_game_reg', 'facebook_web_reg',
                             'facebook_reg', 'email_reg', 'email_validated', 'guest_reg', 'new_reg_game_dau',
                             'paid_user_count', 'paid_count', 'revenue', 'one_day_retention', 'seven_day_retention',
                             'thirty_day_retention', 'mtt_buy_ins', 'sng_buy_ins', 'mtt_rake', 'sng_rake',
                             'ring_game_rake', 'mtt_winnings', 'sng_winnings')
    ...
    new_reg_game_dau = transpose_query_result[11]
    paid_user_count = transpose_query_result[12]
    revenue = transpose_query_result[14]
    one_day_retention_count = transpose_query_result[15]
    seven_day_retention_count = transpose_query_result[16]
    thirty_day_retention_count = transpose_query_result[17]
    ...
    column_names[15:18] = ['one_day_retention(%)', 'seven_day_retention(%)', 'thirty_day_retention(%)']
    ...
    charts_data[13:16] = [one_day_retention, seven_day_retention, thirty_day_retention]
    ...
    transpose_tables_data[15:18] = [one_day_retention, seven_day_retention, thirty_day_retention]
